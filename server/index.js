...
app.post("/api/post", async (req, res) => {
  console.log(req.body.playerStatus.uncap);
  try {
    const newPlayer = await new Player({
      ...
      role: req.body.role,
      playerStatus: {
        cap: req.body.playerStatus.cap,
        uncap: req.body.playerStatus.uncap,
        indian: req.body.playerStatus.indian,
        foreigner: req.body.playerStatus.foreigner,
      },
    });
    newPlayer.save();
    log(newPlayer);
...
app.patch("/api/update/:id", async (req, res) => {
  ...
  const { cap, uncap, indian, foreigner } = req.body.playerStatus;
  try {
